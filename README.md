...
**Instalar em VPS (passo a passo):** [docs/INSTALACAO-VPS.md](./docs/INSTALACAO-VPS.md) · **Hostinger:** [docs/DEPLOY-HOSTINGER.md](./docs/DEPLOY-HOSTINGER.md) · **RebFlow prod:** [docs/DEPLOY-REBFLOW-PROD.md](./docs/DEPLOY-REBFLOW-PROD.md)
